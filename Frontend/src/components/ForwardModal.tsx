...
export const ForwardModal: React.FC<ForwardModalProps> = ({
  ...
  const handleForward = async (conversationId: string) => {
    setIsLoading(true);
    await onForward(messageToForward.id, conversationId);
    setIsLoading(false);
    onClose();
  };
  return (
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 p-4">
        <motion.div
          ...
          <div className="p-4 bg-gray-50 dark:bg-gray-800/50 border-b border-gray-200 dark:border-gray-700 transition-colors">
            <div className="bg-white dark:bg-gray-700 p-3 rounded-lg border border-gray-200 dark:border-gray-600 text-sm text-gray-700 dark:text-gray-200 truncate transition-colors">
          ...
          <div className="overflow-y-auto custom-scrollbar flex-1 p-2">
            ...
            <div
              ...
              className={`flex items-center p-2 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-lg cursor-pointer transition-colors ${isLoading ? 'opacity-50 pointer-events-none' : ''}`}>
