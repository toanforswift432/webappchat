  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className="absolute top-14 right-4 w-48 bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 py-2 z-50 transition-colors duration-200">
